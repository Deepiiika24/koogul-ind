...
import rice1 from '../../assets/images/oil/sunflower-banner.jpg'
...
const Sunfloweroil: React.FC = () => {
    const navigate = useNavigate();
  const product = {
    image: rice1,
    title: 'Sunflower oil',
    description: 'Sunflower oil is rich in vitamin E, making it excellent for skin health by acting as an antioxidant that helps protect against UV damage and aging. It contains healthy unsaturated fats, particularly linoleic acid, which supports heart health by helping to lower bad cholesterol levels. The oil is anti-inflammatory properties can benefit joint health and reduce the risk of chronic diseases. Additionally, sunflower oil is light and has a high smoke point, making it a versatile and healthy option for cooking.',
    details: [
