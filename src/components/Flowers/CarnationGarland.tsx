...
const CarnationGarland: React.FC = () => {
    const navigate = useNavigate();

    const product = {
        image: leaf1,
        title: 'Carnation Garland',
        description: "Our Carnation Garlands, renowned for their vibrant colors and exquisite form, are expertly crafted and meticulously preserved to maintain their stunning beauty. Each garland is made from handpicked carnations, selected at peak freshness and immediately refrigerated to ensure that they arrive in pristine condition. These garlands, symbolizing love, admiration, and celebration, are perfect for weddings, religious ceremonies, and festive occasions.",
        details: [
