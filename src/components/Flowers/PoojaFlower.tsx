...
import leaf1 from '../../assets/images/rice/Matta-rice-banner.jpg'
import Header from '../Header';
import Footer from '../Footer';

const PoojaFlower: React.FC = () => {
    const navigate = useNavigate();

    const product = {
        image: leaf1,
        title: 'Pooja Flower',
        description: "Lorem ipsum dolor sit amet consectetur, adipisicing elit. Recusandae a sequi libero necessitatibus veniam aspernatur minus, error hic odit! Ipsum, rerum adipisci nulla neque quisquam voluptatum sint aut nisi deserunt.",
        details: [
