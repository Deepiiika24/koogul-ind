...
import leaf1 from '../../assets/images/Flower/Bacarrat-carnation-banner.jpg'
import Header from '../Header';
import Footer from '../Footer';

const CarnationBacarat: React.FC = () => {
    const navigate = useNavigate();

    const product = {
        image: leaf1,
        title: 'Bacarrat Carnation Flower',
        description: "Our Bacarrat Carnation flowers, renowned for their rich, deep red hue and elegant form, are carefully selected and preserved to maintain their stunning beauty. Each bloom is handpicked at peak freshness and immediately refrigerated to ensure that the flowers arrive in perfect condition, ready to enhance any occasion with their timeless charm. To guarantee the highest quality, our Bacarrat Carnation flowers are refrigerated immediately after harvesting.",
        details: [
...
export default CarnationBacarat;
