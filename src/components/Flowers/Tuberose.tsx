...
import leaf1 from '../../assets/images/Flower/Tuberose-banner.jpg'
import Header from '../Header';
import Footer from '../Footer';

const Tuberose: React.FC = () => {
    const navigate = useNavigate();

    const product = {
        image: leaf1,
        title: 'Tuberose',
        description: "The Tuberose, known scientifically as Polianthes tuberosa, is celebrated for its intoxicating fragrance and elegant white blooms. These flowers, with their long, slender stems and clusters of star-shaped blossoms, are a symbol of sensuality and purity, making them a cherished choice for various decorative and aromatic applications.",
        details: [
