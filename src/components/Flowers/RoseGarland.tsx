...
import leaf1 from '../../assets/images/Flower/Rose-garland-banner.png'
import Header from '../Header';
import Footer from '../Footer';

const RoseGarland: React.FC = () => {
    const navigate = useNavigate();

    const product = {
        image: leaf1,
        title: 'Rose Garland',
        description: "Rose garlands are a timeless and elegant choice for various ceremonies, especially weddings. Known for their beauty, fragrance, and symbolism, roses add a touch of romance and sophistication to any occasion. These garlands are crafted by stringing together fresh roses, creating a continuous chain of blossoms that can be used in numerous ways.",
        details: [
