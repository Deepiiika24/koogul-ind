...
import rice1 from '../../assets/images/Beeda/chutni.jpg';
import Header from '../Header';
import Footer from '../Footer';

const Sweetpanchutni: React.FC = () => {
    const navigate = useNavigate();

    const product = {
        image: rice1,
        title: 'Sweet Panchutni',
        description: 'Sweet Panchutni from our exporting company is a traditional Indian confectionery celebrated for its unique blend of flavors. Crafted from a rich combination of jaggery, sesame seeds, and aromatic spices, it delivers a delightful sweetness. Perfect for snacking or festive occasions, our Sweet Panchutni embodies authentic taste and quality, ensuring a delightful experience in every bite.',
        productDetails: [
            { label: 'Color', value: 'Gold' },
            { label: 'Item Type', value: 'powder' },
            { label: 'Capacity', value: '100gm' },
            { label: 'Diet Type', value: 'paste' }
        ]
    };
