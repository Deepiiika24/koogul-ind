...
import rice1 from '../../assets/images/flour/Ragi-flour-banner.jpg'
...
const RagiFlour: React.FC = () => {
    const navigate = useNavigate();
  const product = {
    image: rice1,
    title: 'Ragi Flour',
    description: 'Ragi Flour, also known as Finger Millet Flour, is a highly nutritious and gluten-free grain flour packed with calcium, iron, and dietary fiber. It is widely used to prepare traditional dishes like rotis, porridge, and healthy baked goods, making it an excellent choice for a wholesome diet. Known for its low glycemic index, Ragi Flour is ideal for diabetics and health-conscious consumers.',
    details: [
