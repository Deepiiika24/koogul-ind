...
import rice1 from '../../assets/images/flour/Moongdal-banner.jpg'
...
const MoongDalFlour: React.FC = () => {
    const navigate = useNavigate();
  const product = {
    image: rice1,
    title: 'Moong Dal Flour',
    description: 'Moong Dal Flour is a finely ground powder made from high-quality moong dal (split green gram), known for its rich protein content and easy digestibility. It is widely used in traditional Indian cuisine for preparing snacks, savory pancakes, and gluten-free baked goods. This nutritious flour is packed with essential vitamins, minerals, and dietary fiber, making it a healthy choice for various culinary applications.',
    details: [
