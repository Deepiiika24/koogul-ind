...
import rice1 from '../../assets/images/Vegetable/ladyfinger-banner.jpg';
import Header from '../Header';
import Footer from '../Footer';

const Ladyfinger: React.FC = () => {
    const navigate = useNavigate();

    const product = {
        image: rice1,
        title: 'Ladyfinger',
        description: 'Okra , Abelmoschus esculentus, known in some English-speaking countries as ladys fingers, is a flowering plant in the mallow family native to East Africa. It has edible green seed pods. Cultivated in tropical, subtropical, and warm temperate regions around the world, okra is used in the cuisines of many countries.',
        details: [
