...
const images = [
  { img: Flower1, name: "White Carnation" },
  { img: Flower2, name: "Soft Pink Carnation" },
  { img: Flower3, name: "Red Carnation" },
  { img: Flower4, name: "Peach Carnation" },
  { img: Flower5, name: "Orange Carnation" },
  { img: Flower6, name: "Yellow Carnation" },
  { img: Flower7, name: "Soft Purple Carnation" },
  { img: Flower8, name: "Carnation bacarat" },
  { img: Flower9, name: "Purple Carnation" },
  { img: Flower10, name: "Pink Carnation" },
  { img: Flower11, name: "Tuberose" },
  { img: Flower12, name: "Yellow Marigold" },
  { img: Flower13, name: "Orange Marigold" },
  { img: Flower14, name: "Pooja Flower" },
  { img: Flower15, name: "Red Rose" },
  { img: Flower16, name: "Yellow Rose" },
  { img: Flower17, name: "Orange Rose" },
];

const garlands = [
  { img: Garland1, name: "Carnation Garland" },
  { img: Garland2, name: "Rose Garland" },
  { img: Garland3, name: "Wedding Garland" },
  { img: Garland4, name: "Tuberose Garland" },
];

const petals = [
  { img: Petal1, name: "Red Rose Petals" },
  { img: Petal2, name: "Yellow Rose Petals" },
  { img: Petal3, name: "Orange Rose Petals" },
  { img: Petal4, name: "Mixed Rose Petals" },
]

const strings = [
  { img: String1, name: "Jasmine String" },
  { img: String2, name: "Carnation String" },
  { img: String3, name: "Baby Breath" },
  { img: String4, name: "Mixed Marigold String" },
]
...
const getSlides = (arr: { img: string; name: string }[], perSlide: number) => {
  let slides: { img: string; name: string }[][] = [];
                ...
                <Col key={i} xs={12} sm={6} md={3} id='columns'>
                  <div className="rounded p-2">
                    <div className="card" style={{ height: 300 }}>
                      ...
                      />
                      <h5 className='py-3'>{data.name}</h5>
                    </div>
                  </div>
                </Col>
              ))}
