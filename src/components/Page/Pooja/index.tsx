...
const images: PoojaItem[] = [
  { id: 1, name: "Sudrashana Pooja", img: Flower1, path: "" },
  { id: 2, name: "varalakshmi Pooja", img: Flower2, path: "" },
  { id: 3, name: "Shiva pooja", img: Flower3, path: "" },
  { id: 4, name: "Satyanarayana pooja", img: Flower4, path: "" },
  { id: 5, name: "Haridarshan Pooja", img: Flower5, path: "" },
  { id: 6, name: "Navgraha Pooja", img: Flower6, path: "" },
  { id: 7, name: "Ganapathi Pooja", img: Flower7, path: "" },
  { id: 8, name: "108 Om Thiraviya", img: Flower8, path: "" },
  { id: 9, name: "Durga Pooja", img: Flower9, path: "" },
];

const garlands: PoojaItem[] = [
  { id: 1, img: brass1, name: "Kalash", path: "" },
  { id: 2, img: brass2, name: "Bell", path: "" },
  { id: 3, img: brass3, name: "kunkum Plate", path: "" },
  { id: 4, img: brass4, name: "Agarbatti holder", path: "" },
  { id: 5, img: brass5, name: "Thalika", path: "" },
  { id: 6, img: brass6, name: "Lota", path: "" },
];

const petals: PoojaItem[] = [
  { id: 1, img: spiritual1, name: "Kungumam", path: "" },
  { id: 2, img: spiritual2, name: "Kottai Pakku", path: "" },
  { id: 3, img: spiritual3, name: "Cow Dung Cake", path: "" },
  { id: 4, img: spiritual5, name: "Sival Pakku", path: "" },
  { id: 5, img: spiritual6, name: "Koppara Thenga", path: "" },
  { id: 6, img: spiritual7, name: "Vetti Ver", path: "" },
  { id: 7, img: spiritual8, name: "Vibuthi", path: "" },
  { id: 8, img: spiritual9, name: "Omam Kit 108", path: "" },
]

const strings: PoojaItem[] = [
  { id: 1, img: harbel1, name: "Paneer Water", path: "" },
  { id: 2, img: harbel2, name: "Sambrani Powder", path: "" },
  { id: 3, img: harbel3, name: "Sandhanam Powder", path: "" },
  { id: 4, img: harbel4, name: "Sandhanam Katti", path: "" },
  { id: 5, img: harbel5, name: "Panchi Nool", path: "" },
  { id: 6, img: harbel6, name: "Sambrani Cup", path: "" },
  { id: 7, img: harbel7, name: "Kalasa Nool", path: "" },
  { id: 8, img: harbel8, name: "Karpuram", path: "" },
  { id: 9, img: harbel9, name: "Katti Manjal", path: "" },
  { id: 10, img: harbel10, name: "Namaa Katti", path: "" },
  { id: 11, img: harbel11, name: "Kasthuri Manjal", path: "" },
  { id: 12, img: harbel12, name: "Navathaniyam", path: "" },
]
const natural: PoojaItem[] = [
  { id: 1, img: natural1, name: "Grass", path: "/natural1" },
  { id: 2, img: natural2, name: "Nel", path: "/natural1" },
  { id: 3, img: natural3, name: "Mango Stick", path: "/natural1" },
  { id: 4, img: natural4, name: "Nel Pori", path: "/natural1" },
  { id: 5, img: natural5, name: "Arasan Kattai", path: "/natural1" },
];
