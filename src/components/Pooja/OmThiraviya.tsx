...
import rice1 from '../../assets/images/pooja/kit8.jpg';
import Header from '../Header';
import Footer from '../Footer';

const OmThiraviya: React.FC = () => {
    const navigate = useNavigate();

    const product = {
        image: rice1,
        title: '108 Om Thiraviya Samangal  Pooja',
        description: 'The 108 Om Thiraviya Samangal Pooja is a spiritual ritual that involves the recitation of 108 sacred mantras or names of deities in a single session. This pooja is performed to invoke the blessings of the divine and to bring peace, prosperity, and spiritual well-being to the devotees.',
        details: [
