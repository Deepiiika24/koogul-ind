...
import rice1 from '../../../assets/images/pooja/kalasanool.jpg';
import Header from '../../Header';
import Footer from '../../Footer';

const Kalasanool: React.FC = () => {
    const navigate = useNavigate();

    const product = {
        image: rice1,
        title: 'Kalasa Nool',
        description: 'Kalasa Nool, also known as Kalasa, refers to the sacred pot or vessel used in Hindu rituals and ceremonies. It is typically filled with water and adorned with various items like mango leaves, a coconut, and other auspicious materials. The Kalasa is considered a symbol of abundance, fertility, and the divine presence. In many Hindu traditions, the Kalasa is used in rituals like Poojas (worship ceremonies), weddings, and other auspicious occasions. The water from the Kalasa is believed to purify and sanctify the surroundings, and it is often sprinkled around the area or on participants to bless them.',
        productDetails: [
            { label: 'Color', value: 'White' },
            { label: 'Item Shape', value: 'Round' },
            { label: 'Capacity', value: '100gm' },
            { label: 'Primary Material', value: 'thread' }
        ]
    };
