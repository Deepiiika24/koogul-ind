...
import rice1 from '../../assets/images/snacks/Garlic-mixture-banner.jpg'
...
const Garlicmixture: React.FC = () => {
    const navigate = useNavigate();
  const product = {
    image: rice1,
    title: 'Garlic mixture',
    description: 'Garlic mixture is a savory and crunchy Indian snack blend featuring roasted nuts, crunchy chickpea flour noodles (sev), and spices, with a distinct garlic flavor. It offers a perfect balance of textures and flavors, combining the earthy taste of garlic with the crunchiness of nuts and sev. Our exporting company specializes in crafting garlic mixture using premium quality ingredients sourced directly from trusted suppliers. We ensure each batch maintains its authentic taste and quality, making it a favorite snack choice both locally and internationally. Emphasizing on taste, quality, and freshness, we aim to deliver a delightful snacking experience to our customers worldwide.',
    details: [
