...
import rice1 from '../../assets/images/snacks/White-sesame-banner.jpg'
...
const Whitesesameballs: React.FC = () => {
    const navigate = useNavigate();
  const product = {
    image: rice1,
    title: 'White sesame balls',
    description: 'White sesame balls, also known as tilgul or ellu urundai in Indian cuisine, are delightful spherical treats made from roasted white sesame seeds and jaggery (unrefined cane sugar). These balls are popular during festivals like Makar Sankranti in India, symbolizing sweetness and auspiciousness. The sesame seeds impart a nutty flavor, while the jaggery provides a rich caramel-like sweetness, creating a harmonious blend of textures and tastes. As an exporting company specializing in white sesame balls, you can highlight their traditional recipe and cultural significance, making them a cherished choice among consumers celebrating festive occasions worldwide.',
    details: [
