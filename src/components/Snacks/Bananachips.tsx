...
import rice1 from '../../assets/images/snacks/Banana-chips-banner.jpg'
...
const Bananachips: React.FC = () => {
    const navigate = useNavigate();
  const product = {
    image: rice1,
    title: 'Banana Chips',
    description: 'A premier exporter of exquisite banana chips sourced from the heartlands of India. Our commitment to quality shines through in every crisp and savory bite of our meticulously crafted banana chips. With a passion for authenticity and flavor, we bring the essence of traditional Indian snacking to global markets, ensuring each batch meets the highest standards of taste and freshness. Explore our range of banana chips and experience the essence of South Indian culinary tradition. Banana chips are a beloved South Indian snack known for their crunchy texture and delightful taste. Made from ripe bananas that are thinly sliced and deep-fried to perfection, these chips offer a unique blend of sweet and savory flavors.',
    details: [
