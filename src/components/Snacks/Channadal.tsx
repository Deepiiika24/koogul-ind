...
import rice1 from '../../assets/images/snacks/Kadala-parupu-banner.jpg'
...
const Channadal: React.FC = () => {
    const navigate = useNavigate();
  const product = {
    image: rice1,
    title: 'Channa dal',
    description: 'Channa dal, also known as split chickpeas, is a versatile legume widely used in Indian cuisine. It is known for its nutty flavor and firm texture, making it a staple ingredient in various dishes and snacks. Our exporting company takes pride in sourcing the finest channa dal from trusted suppliers, ensuring superior quality and freshness. Whether roasted as a crunchy snack or used in curries and soups, our channa dal meets stringent quality standards to deliver a delightful culinary experience. We prioritize authenticity and taste, catering to global markets with a commitment to excellence in every batch we export.',
    details: [
